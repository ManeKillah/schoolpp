...
// import Associatedcontainers from "../components/associated-containers";
// import Observations from "../components/observations";

export default function ContainerDetails({ container }: { container: Container }) {
  const router = useRouter();
  const [activeTab, setActiveTab] = useState(0);
  const {observations} = useSelectContainer(container.reference_pre);
  ...
  // console.log( typeof container.start_date, container.start_date);
    ...
    <div>
      ...
      <TabList style={{ display: "flex", gap: "10px" }}>
        ...
        <div>
          <div className="section">
            <div className="flex flex-col lg:flex-row items-start justify-between w-full mb-6">
              <Label className="text-lg font-bold" htmlFor="container-info">General</Label>
              <div className="w-full lg:w-auto flex flex-wrap">
                ...
                <div className="w-1/2">
                  <Label htmlFor="reference">{container.store_name}</Label>
                </div>
              </div>
              {/* <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                <div className="w-1/2 pr-2">
                ...
                <div className="w-1/2">
                  <Label htmlFor="reference">{container.status}</Label>
                </div>
              </div> */}
              <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                <div className="w-1/2 pr-2">
                ...
                <div className="w-1/2">
                  <Label htmlFor="reference">{container.location}</Label>
                </div>
              </div>
              {/* <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                <div className="w-1/2 pr-2">
                ...
                <div className="w-1/2">
                  <Label htmlFor="reference">{container.name}</Label>
                </div>
              </div> */}
            </div>
          ...
          <div className="section">
            <div className="flex flex-col lg:flex-row items-start justify-between w-full mb-6">
              <Label className="text-lg font-bold" htmlFor="container-info">Datos contables</Label>
              <div className="w-full lg:w-auto flex flex-wrap">
              <div className="w-full lg:w-1/2 lg:pr-4 mb-4 lg:mb-0 flex flex-col lg:flex-row">
                <div className="w-full lg:w-1/3 mb-1 lg:mb-0 pr-2">
                  <Label htmlFor="reference" className="font-bold">Ref contable:</Label>
                </div>
                <div className="w-full lg:w-2/3">
                  <Label htmlFor="reference">{container.reference_con}</Label>
                </div>
              </div>
              <div className="w-full lg:w-1/2 lg:pl-4 mb-3 lg:mb-0 flex flex-col lg:flex-row">
                <div className="w-full lg:w-1/3 mb-1 lg:mb-0 pr-2">
                  <Label htmlFor="reference" className="font-bold">Importe:</Label>
                </div>
                <div className="w-full lg:w-2/3">
                  <Label htmlFor="reference">{container.import}</Label>
                </div>
              </div>
            </div>
          ...
          <div className="section">
            <div className="flex flex-col lg:flex-row items-start justify-between w-full mb-6">
              <Label className="text-lg font-bold" htmlFor="container-info">Datos de mantenimiento</Label>
              <div className="w-full lg:w-auto flex flex-wrap">
                <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                <div className="w-1/2 pr-2">
                  <Label htmlFor="reference" className="font-bold">Ref contable:</Label>
                ...
                <div className="flex">
                    ...
                    <Label htmlFor="reference">
                      ...
                      {new Date(container.review_date).toLocaleDateString()}
                    </Label>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                ...
                <div className="flex items-center">
                    ...
                    <Label htmlFor="reference">
                      {/* Utiliza el formato deseado para la presentación de las fechas */}
                      {new Date(container.in_date).toLocaleDateString()}
                    </Label>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2 mb-3 lg:pr-2 flex">
                ...
                <div className="flex items-center">
                    ...
                    <Label htmlFor="reference">
                      {/* Utiliza el formato deseado para la presentación de las fechas */}
                      {new Date(container.out_date).toLocaleDateString()}
                    </Label>
                  </div>
                </div>
              </div>
          ...
          <div className="section">
            <div className="flex flex-col lg:flex-row items-start justify-between w-full mb-6">
              <Label className="text-lg font-bold" htmlFor="container-info">Motivo de baja</Label>
              <div className="w-full lg:w-auto flex flex-wrap border rounded-lg p-4" style={{ width: '300px', height: '100px' }}>
                  <div className="w-full lg:pr-2">
                    <div className="mb-3">
                      <Label>{container.out_motive}</Label>
                    </div>
                  </div>
                </div>
            </div>
        ...
        <TabPanel>
          <h3>hello1</h3>
          <h3>hello2</h3>
          {/* <Associatedcontainers containerId={container.id} /> */}
        </TabPanel>
        <TabPanel>
        <h3>Galeria</h3>
          <Slider dots={true}>
